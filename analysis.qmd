...
p1 <- data %>% 
  ...
  ggtitle("Scatter Plot of Cities vs User Number per Population") + guides(color = guide_legend(title = "Value"))+
  theme_minimal() +
...
ggplot(tidy_data, aes(x = year, y = rate_value, fill = rate_type)) +
  ...
  theme(axis.text.x = element_text(angle = 0, hjust = 1),plot.title = element_text(size = 12, hjust = 0.5)) +
