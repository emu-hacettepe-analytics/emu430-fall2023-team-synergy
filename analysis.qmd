...
### 2.5) The Effect of Literacy Rate on Suicide Rates Top 10 cities in 2020
...
print(paste("Correlation between loaned book number and number of suicides:", correlation))
...
ggplot(tidy_data, aes(x = year, y = rate_value, fill = rate_type)) +
  ...
  labs(
    title = "Rates Distribution across Years and Cities",
    x = "Years",
    y = " Value",
    fill = " Types"
  ) +
...
### 4.3) Cinema Audience Number of the top 10 cities in 2020
...
print(paste("Correlation between population and cinema audiences number:", correlation))
...
### 4.4) Rate Distribution For Regions
...
ggplot(tidy_data, aes(x = region, y = rate_value, fill = rate_type)) +
  geom_bar(stat = "identity", position = "dodge", width = 0.7) +
  labs(
    title = "Rates Distribution for Regions",
    x = "Region",
    y = " Value",
    fill = " Types"
  ) +
...
### 4.5)Museum Visitor vs. Loaned book
