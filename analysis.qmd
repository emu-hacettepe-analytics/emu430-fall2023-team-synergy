...
ege <- c("İzmir", "Aydın", "Muğla", "Manisa", "Denizli", "Uşak", "Kütahya", "Afyon")
...
library_museum_updated <- library_museum_updated %>% mutate(region = sapply(city, assign_region)) %>% relocate(region,.after = city)
```
