...
data|>
  filter(year==2022)|>
ggplot(aes(x = literacy_rate, y = prop_youth_population)) +
  geom_point(color = "purple") +  
  geom_smooth(method = "lm", se = FALSE, color = "yellow", formula = y ~ x)+ 
  labs(x = "Literacy Rate", y = "Proportion of Youth Population") + 
  ggtitle("Scatter Plot of Literacy Rate vs Proportion of Youth Population") +
  theme_minimal() +
...
data %>%
  ...
  geom_point(color = "purple") +  
  geom_smooth(method = "lm", se = FALSE, color = "yellow", formula = y ~ x) + 
  labs(x = "Cities", y = "Book Number Per Population (*100) in 2022") + 
...
data %>%
  ...
  geom_point(color = "purple") +  
  geom_smooth(method = "lm", se = FALSE, color = "yellow", formula = y ~ x) + 
  labs(x = "Cities", y = "Museum Number Per Population (*100000) in 2022") + 
