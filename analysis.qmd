...
It can be stated that there is a strong relationship according to the correlation.
...
kable(top10_museum, 
      ...
      align = c("c", "c")) 
```
The table above shows the top 10 cities in Turkey for the year 2022 with the most museums in cities with historical remnants.
...
```
This table illustrates the cities in Turkey with the most historical remnants for the year 2022. When we compare this with the previous table, we can observe similarities. Let's visualize this as well.
